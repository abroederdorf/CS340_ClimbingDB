		...
		<div id="pageDiv">
			...
			<p>
				<?php	
					...
					if(!($stmt = $mysqli->prepare("DELETE FROM mtn_routeClimbed WHERE rid = ? AND cid = ? AND climbDate = ?"))){
						echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
					}
					if(!($stmt->bind_param("iis",$_POST['delRouteRtCl'],$_POST['delClimberRtCl'],$_POST['delDateClimbed']))){
