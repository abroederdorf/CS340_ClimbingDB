		...
		<div id="pageDiv">
			...
			<p>
				<?php	
					...
					if(!($stmt = $mysqli->prepare("INSERT INTO mtn_skill(name) VALUES (?)"))){
					...
					if(!$stmt->execute()){
						...
						if ($stmt->affected_rows == 0)
							echo "Error, added " . $stmt->affected_rows . " rows to mtn_skill.";
						else
							echo "Added " . $stmt->affected_rows . " row to mtn_skill.";
